...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 09 mei 2022 om 14:19
...
--
DROP DATABASE IF EXISTS `database_information`;
CREATE DATABASE IF NOT EXISTS `database_information` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `database_information`;
...
('root', '[{\"db\":\"database_information\",\"table\":\"gegevens\"}]');
...
('root', '2022-05-09 12:13:55', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"nl\"}');
